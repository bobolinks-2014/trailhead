...
feature 'trail page view' do
	...
	before do
		...
		it "should dynamically reveal more comments when the 'see more comments' button is clicked" do
			...
			expect(page).should have_content("Culpa sequi reiciendis inventore aut. Sed ipsa consequatur. Qui qui magnam nisi eos. Dignissimos eum impedit quibusdam a enim molestias. Voluptatem vitae omnis molestiae sit. Dolorum earum nulla at a harum esse. Id atque voluptas cupiditate labore.")
			end
		end
